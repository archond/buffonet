...
<head>
    ...
    <?php /*select2*/ ?>
    <?php /*<link rel="stylesheet" href="<?php echo e(URL::asset('admin-assets/js/select2-4.0.2/dist/css/select2.min.css')); ?>">*/ ?>
    <?php /*<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.2/css/select2.min.css">*/ ?>
    <?php /*<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/select2/3.5.1/select2.css">*/ ?>
    <link href="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.2/css/select2.min.css" rel="stylesheet" />
    <?php /*<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/select2/3.5.1/select2-bootstrap.min.css">*/ ?>
    <?php /*multi select*/ ?>
    ...
    <link rel="stylesheet" href="<?php echo e(URL::asset('admin-assets/js/tokenfield/css/bootstrap-tokenfield.min.css')); ?>" type="text/css">
    <link rel="stylesheet" href="<?php echo e(URL::asset('admin-assets/js/tagsinput/bootstrap-tagsinput.css')); ?>" type="text/css">
    <link rel="stylesheet" href="<?php echo e(URL::asset('admin-assets/js/tokenfield/css/tokenfield-typeahead.min.css')); ?>" type="text/css">
    ...
    <link rel="stylesheet" href="<?php echo e(URL::asset('admin-assets/jquery-textext/src/css/textext.plugin.tags.css')); ?>" type="text/css">
    <link rel="stylesheet" href="<?php echo e(URL::asset('admin-assets/jquery-textext/src/css/textext.plugin.autocomplete.css')); ?>" type="text/css">
    <link rel="stylesheet" href="<?php echo e(URL::asset('admin-assets/lightbox2-master/src/css/lightbox.css')); ?>" type="text/css">


    <?php echo $__env->yieldContent('css'); ?>
    <?php /*<script src="<?php echo e(URL::asset('admin-assets/js/jquery-1.11.1.min.js')); ?>"></script>*/ ?>
    ...
    <body class="page-body">
            ...
            <div class="sidebar-menu toggle-others fixed collapsed">
                <div class="sidebar-menu-inner">    
                    <header class="logo-env">
                        <!-- logo -->
                        <div class="logo">
                            <a href="<?php echo e(URL::route('index')); ?>" class="logo-expanded">
                                <img src="<?php echo e(URL::asset('img/WebEmbassyLogo_s.png')); ?>" alt="" />
                            </a>
                            <a href="<?php echo e(URL::route('index')); ?>" class="logo-collapsed">
                                <img src="<?php echo e(URL::asset('img/WebEmbassyLogo_l.png')); ?>" width="40" alt="" />
                                <?php /*<div style="font-size:35px;color:#FEF9F9;margin:3px;font-family: monospace">WE</div>*/ ?>
                            </a>
            ...
            <div class="main-content">
                ...
                <nav class="navbar user-info-navbar" role="navigation">
                    ...
                    <ul class="user-info-menu right-links list-inline list-unstyled">
                        ...
                        <?php echo $__env->make('includes.languages-bar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                ...
                <button class="btn" onclick="history.back()"><?php echo e(_('Go Back')); ?></button>
        ...
        <script src="<?php echo e(URL::asset('admin-assets/js/tokenfield/bootstrap-tokenfield.min.js')); ?>"></script>
        <script src="<?php echo e(URL::asset('admin-assets/js/tagsinput/bootstrap-tagsinput.min.js')); ?>"></script>
        ...
        <script src="<?php echo e(URL::asset('admin-assets/lightbox2-master/src/js/lightbox.js')); ?>"></script>
        ...
        <script src="<?php echo e(URL::asset('admin-assets/jquery-textext/src/js/textext.plugin.ajax.js')); ?>"></script>
        <?php /*select2*/ ?>
        <?php /*<script src="<?php echo e(URL::asset('admin-assets/js/select2-4.0.2/dist/js/select2.min.js')); ?>"></script>*/ ?>
        <?php /*<script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.2/js/select2.full.min.js"></script>*/ ?>
        <?php /*<script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.2/js/select2.full.js"></script>*/ ?>
        <?php /*<script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.0-rc.2/js/select2.full.min.js"></script>*/ ?>


        <?php /*<script src="https://cdnjs.cloudflare.com/ajax/libs/select2/3.5.1/select2.min.js"></script>*/ ?>
        <?php /*multiselect*/ ?>
