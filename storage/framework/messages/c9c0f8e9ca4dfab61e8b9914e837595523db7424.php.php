<?php $__env->startSection('content'); ?>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title"<?php echo e(_('Edit Country')); ?></h3>
        </div>
        <div class="panel-body">


            <?php echo Form::model($country, ['class'=>'form-horizontal', 'method'=>'put','files'=>'true','route' => ['countries.update', $country->id ] ]); ?>
